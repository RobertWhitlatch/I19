...
class MotorDepot(object):
    ...
    def close_depot(self):
        for i in range(2):
            if self._board_status[i]:
                self._gpio[i].write8(0x01, 0xF0)
                self._pwm[i].write8(0x00, 0x30)
...
class Stepper(object):
    ...
    def spin_standard(self, direction):
        load = [0x00, 0x00, 0xFF, 0x03,
                0x00, 0x08, 0xFF, 0x0B,
                0x00, 0x04, 0xFF, 0x07,
                0x00, 0x0C, 0xFF, 0x0F]
        load_n = [0x00, 0x0C, 0xFF, 0x0F,
                  0x00, 0x04, 0xFF, 0x07,
                  0x00, 0x08, 0xFF, 0x0B,
                  0x00, 0x00, 0xFF, 0x03]
    ...
    def spin_torque(self, direction):
        load = [0x00, 0x00, 0xFF, 0x07,
                0x00, 0x08, 0xFF, 0x0F,
                0x00, 0x04, 0xFF, 0x0B,
                0x00, 0x0C, 0xFF, 0x03]
        load_n = [0x00, 0x0C, 0xFF, 0x03,
                  0x00, 0x04, 0xFF, 0x0B,
                  0x00, 0x08, 0xFF, 0x0F,
                  0x00, 0x00, 0xFF, 0x07]
    ...
    def spin_half(self, direction):
        load = [0x00, 0x0E, 0xFF, 0x03,
                0x00, 0x06, 0xFF, 0x0B,
                0x00, 0x02, 0xFF, 0x07,
                0x00, 0x0A, 0xFF, 0x0F]
        load_n = [0x00, 0x0A, 0xFF, 0x0F,
                  0x00, 0x02, 0xFF, 0x07,
                  0x00, 0x06, 0xFF, 0x0B,
                  0x00, 0x0E, 0xFF, 0x03]
